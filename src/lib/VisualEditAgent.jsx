...
export default function VisualEditAgent() {
	...
	const handleElementClick = (e) => {
		...
		// Create a clean data object without non-serializable properties
		const elementData = {
			type: 'element-selected',
			tagName: String(element.tagName),
			classes: String(element.className?.baseVal || element.className || ''),
			visualSelectorId: visualSelectorId,
			content: String(element.innerText || ''),
			dataSourceLocation: String(element.dataset.sourceLocation || ''),
