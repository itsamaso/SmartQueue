...
import { LogIn, Phone, Lock, Eye, EyeOff, ArrowRight, Sparkles, Shield } from "lucide-react";
    ...
    <div className="min-h-screen bg-transparent flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div ref={formRef} className="rounded-3xl p-6 sm:p-8 max-w-md w-full shadow-2xl relative z-10 border" style={{ background: '#3A3D44', borderColor: 'rgba(222,198,167,0.2)' }}>
        ...
        <Button
          variant="ghost"
          onClick={handleBack}
          className="absolute top-4 right-4 text-yellow-500 hover:text-yellow-400 hover:bg-yellow-500/10 z-10"
        >
        ...
        <div className="text-center mb-8">
          ...
          <div ref={headerRef} className="opacity-0">
            <h1 className="text-2xl sm:text-3xl font-bold" style={{ color: '#DEC6A7' }}>כניסת מנהל</h1>
        ...
        <div className="mt-8 text-center">
          <p className="text-sm" style={{ color: 'rgba(255,255,255,0.6)' }}>
            אין לך חשבון מנהל?{" "}
            <button
              onClick={() => navigate(createPageUrl("AdminSignUp"))}
